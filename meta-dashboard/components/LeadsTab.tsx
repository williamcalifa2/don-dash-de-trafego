                    ...
                    <div key={col.key} style={{
                      ...
                      {col.key === 'status' ? (
                        ...
                        <div style={{ width: '100%', padding: '0 8px', display: 'flex', alignItems: 'center', gap: 6, fontSize: 12, minWidth: 0 }}>
                          ...
                          {lead.origem && lead.origem !== 'meta' && (
                            <span className="badge" style={{ fontSize: 10, padding: '1px 5px', background: 'var(--accent-soft)', color: 'var(--accent)', textTransform: 'capitalize' }}>
                              {lead.origem === 'shopify_checkout' ? 'checkout' : lead.origem}
                            </span>
                          )}
